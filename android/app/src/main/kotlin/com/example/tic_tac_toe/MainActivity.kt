...
class MainActivity : FlutterActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pubNubConfiguration = PNConfiguration("MyUniqueUUID")
        pubNubConfiguration.subscribeKey = "sub-c-fb43c317-4d27-48e6-bedb-03cb33ccb423"
        pubNubConfiguration.publishKey = "pub-c-f5853114-f7a0-44a0-8ce4-219580b01184"
        ...
        pubNub.let {
            it?.addListener(object :SubscribeCallback(){
                ...
                override fun message(pubnub: PubNub, pnMessageResult: PNMessageResult) {
                    ...
                    if(pnMessageResult.message.asJsonObject["message"] != null){
