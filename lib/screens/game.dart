...
import 'package:tic_tac_toe/models/message.dart';
  ...
  void _configurePubNub() {
    platform.setMethodCallHandler((call) async {
      ...
      if (action == "sendAction") {
        ...
        if (splitted[0] == (game?.creator == true ? 'p2' : 'p1')) {
          ...
          return AlertDialog(
            ...
            actions: [
              ElevatedButton(
                  onPressed: () async {
                    Navigator.pop(context);
                    await _sendAction("chat", {
                      'message':
                          '${game!.creator ? 'p1' : 'p2'}|${sendMessageController.text}'
                    });
                  },
